let zoneName,country,county,latitude,longitude,radius,timezone;
let grpName,grpCountry,grpCounty,grpLat,grpLong,grpRadius,grpTimezone;
...
function init() {
    ...
    if (document.querySelector('#country')){
        ...
        grpCountry = document.querySelector('#grpCountry');
...
function hideDetailsAlerts(){
    ...
    document.querySelector('#country').addEventListener('input', function (){
        removeError(grpCountry);
    });
    document.querySelector('#county').addEventListener('input', function (){
        removeError(grpCounty);
    });
